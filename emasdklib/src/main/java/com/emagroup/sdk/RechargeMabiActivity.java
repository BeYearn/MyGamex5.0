        ...
        public void handleMessage(android.os.Message msg) {
            switch (msg.what) {
                ...
                case EmaConst.PAY_RESULT_DELAYED:  // 延迟发货的提醒
                    new EmaDialogPayPromptResult(RechargeMabiActivity.this, 0, EmaConst.PAY_RESULT_DELAYED, "支付成功\n道具发放可能存在延迟，请耐心等待。").show();
                    break;
                case PayTrdActivity.PAY_ACTIVITY_CLOSE:  //顺利支付完成后 关闭支付订单页面（本页面）
                    RechargeMabiActivity.this.finish();
                    ToolBar.getInstance(RechargeMabiActivity.this).showToolBar();
                    break;
    ...
    private void initView() {
        ...
        mGridView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View view, int position, long arg3) {
                ...
                rechargePayInfo.setOrderId("xxxxxxxx");
